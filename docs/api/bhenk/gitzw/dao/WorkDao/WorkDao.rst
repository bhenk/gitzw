...
.. table::
   ...
   hierarchy  :ref:`bhenk\gitzw\dao\WorkDao` -> `AbstractDao <http://bhenkmsdata.rtfd.io/>`_ 
   ========== ============================================================================== 
...
.. _bhenk\gitzw\dao\WorkDao::Constants:

Constants
+++++++++


.. _bhenk\gitzw\dao\WorkDao::TABLE_NAME:
...
.. _bhenk\gitzw\dao\WorkDao::TABLE_DEFINITION_FILE:

WorkDao::TABLE_DEFINITION_FILE
------------------------------
...
.. code-block:: php
   ...
   string(80) "/Users/ecco/PhpstormProjects/gitzw/application/bhenk/gitzw/dao/sql/tbl_wor ...
...
.. _bhenk\gitzw\dao\WorkDao::Methods:

Methods
+++++++


.. _bhenk\gitzw\dao\WorkDao::getDataObjectName:

WorkDao::getDataObjectName
--------------------------
...
.. _bhenk\gitzw\dao\WorkDao::getTableName:

WorkDao::getTableName
---------------------
...
.. _bhenk\gitzw\dao\WorkDao::getCreateTableStatement:

WorkDao::getCreateTableStatement
--------------------------------
...
.. _bhenk\gitzw\dao\WorkDao::dropTable:
...
.. _bhenk\gitzw\dao\WorkDao::createTable:
...
.. _bhenk\gitzw\dao\WorkDao::insert:
...
.. _bhenk\gitzw\dao\WorkDao::insertBatch:
...
.. _bhenk\gitzw\dao\WorkDao::update:
...
.. _bhenk\gitzw\dao\WorkDao::updateBatch:
...
.. _bhenk\gitzw\dao\WorkDao::delete:
...
.. _bhenk\gitzw\dao\WorkDao::deleteBatch:
...
.. _bhenk\gitzw\dao\WorkDao::select:
...
.. _bhenk\gitzw\dao\WorkDao::selectBatch:
...
.. _bhenk\gitzw\dao\WorkDao::deleteWhere:
...
.. _bhenk\gitzw\dao\WorkDao::selectWhere:
...
.. _bhenk\gitzw\dao\WorkDao::execute:
